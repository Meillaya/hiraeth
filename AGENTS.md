...
- LiveView owns the browser UI. Build all v1 browser experiences with Phoenix LiveView, HEEx, Tailwind CSS, and Phoenix component conventions.
- No React, no Vite SPA, and no separate frontend application in v1.
- Use the `agy` CLI for UI design exploration before implementing substantial page or component design work.
